...
describe('ethereum client', async () => {
  ...
  it('should call invokeSmartContract and throw reject', async () => {
    ...
    try {
      ...
      expect(error).toEqual(new HancockError('SDKINT_001', 500, 'No key nor provider'));
    }
  ...
  it('should call callSmartContract and throw error', async () => {
    ...
    const checkStatusSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'errorHandler')
      .mockImplementation(() => { throw new HancockError('SDKAPI_001', 500, 'testError'); });
    ...
    try {
      ...
      expect(error).toEqual(new HancockError('SDKAPI_001', 500, 'testError'));
    }
  ...
  describe('::tokenRegister', () => {
    ...
    it('should call registerSmartContract and throw error', async () => {
      ...
      const throwedError = new HancockError('SDKAPI_001', 500, 'testError');
      const checkStatusSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'errorHandler')
  ...
  it('should call getBalance and throw error', async () => {
    ...
    const checkStatusSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'errorHandler')
      .mockImplementation((res) => { throw new HancockError('SDKAPI_002', res.code, res.description); });
  ...
  it('should call errorHandler with error correctly', async () => {
    ...
    try {
      (client as any).errorHandler(new HancockError('SDKAPI_001', 500, 'testError'));
      fail('it should fail');
    } catch (error) {
      expect(error).toEqual(new HancockError('SDKAPI_001', 500, 'testError'));
    }
  ...
  it('should call errorHandler without error correctly', async () => {
    ...
    try {
      ...
      expect(error).toEqual(new HancockError('SDKAPI_001', 500, 'testErrorBody'));
    }
  ...
  describe('::tokenTransferFrom', () => {
    ...
    it('should call tokenTransferFrom correctly', async () => {
      ...
      const adaptTokenTransferFromSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'adaptTokenTransferFrom')
        .mockImplementation(() => Promise.resolve({ test: 'test' }));
  ...
  it('should call getTokenMetadata and throw error', async () => {
    ...
    const checkStatusSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'errorHandler')
      .mockImplementation((res) => { throw new HancockError('SDKAPI_002', JSON.parse(res).result.code, JSON.parse(res).result.description); });
    ...
    try {
      ...
      expect(error).toEqual(new HancockError('SDKAPI_002', 500, response.GET_TOKEN_METADATA_ERROR_RESPONSE.result.description));
    }
  ...
  it('should call tokenApprove correctly', async () => {
    ...
    const adaptTokenApproveSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'adaptTokenApprove')
      .mockImplementation(() => Promise.resolve({ test: 'test' }));
    const signAndSendSpy = jest.spyOn((HancockEthereumClient.prototype as any), 'signAndSend')
      .mockImplementation(() => Promise.resolve('ok!'));
