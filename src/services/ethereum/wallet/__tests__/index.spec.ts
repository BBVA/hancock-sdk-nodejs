...
import { HancockEthereumWalletClient } from '..';
...
describe('HancockEthereumWalletClient', async () => {

  let client: HancockEthereumWalletClient;
  const genericConfig = {
    host: 'genericHost',
    port: 1,
    base: 'genericBase',
  ...
  beforeEach(() => {
    ...
    client = new HancockEthereumWalletClient(config);
