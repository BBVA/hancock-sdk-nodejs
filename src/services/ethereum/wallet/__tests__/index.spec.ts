...
import { HancockEthereumWalletService } from '..';
...
describe('HancockEthereumWalletService', async () => {

  let client: HancockEthereumWalletService;
  const genericConfig = {
    host: 'genericHost',
    port: 1,
    base: 'genericBase',
  ...
  beforeEach(() => {
    ...
    client = new HancockEthereumWalletService(config);
